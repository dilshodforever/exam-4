...
func Load() Config {
  ...
  config.HTTPPort = cast.ToString(getOrReturnDefaultValue("HTTP_PORT", ":8088"))
  ...
  config.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "lerning"))
